...
local CoreGui            = game:GetService("CoreGui") -- FIX: ط£ط¶ظپظ†ط§ CoreGui ظ„ظ„ط§ط³طھط®ط¯ط§ظ…

local request = http_request or request or (syn and syn.request) or (http and http.request) or (fluxus and fluxus.request)
if not request then
    -- FIX: ط§ط³طھط®ط¯ط§ظ… HttpService:RequestAsync ظƒط¨ط¯ظٹظ„
...
-- ============================================================
-- FIX: طھط¹ط±ظٹظپ getRagTimerLbl ظ…ط¨ظƒط±ط§ظ‹ (ظ†ظ‚ظ„ظ†ط§ظ‡ط§ ط¥ظ„ظ‰ ط£ط¹ظ„ظ‰)
-- ============================================================
...
-- ============================================================
-- FIX: طھط¹ط±ظٹظپ VezyFlashSave ط¥ط°ط§ ظ„ظ… طھظƒظ† ظ…ظˆط¬ظˆط¯ط©
-- ============================================================
if not _G._VezyFlashSave then
    _G._VezyFlashSave = function(success)
        if success then
            print("[Green Duels] Save successful")
        else
            warn("[Green Duels] Save failed")
        end
    end
end

-- ============================================================
-- FIX: طھط¹ط±ظٹظپ hookfunction ظˆ newcclosure ط¨ط´ظƒظ„ ط¢ظ…ظ†
-- ============================================================
local hookfunction = hookfunction or (syn and syn.hookfunction) or (getgenv and getgenv().hookfunction) or function(f, g) return f end
local newcclosure = newcclosure or (syn and syn.newcclosure) or (getgenv and getgenv().newcclosure) or function(f) return f end

-- ============================================================
-- FIX: Missing variables (ظƒط§ظ†طھ ظ…ظˆط¬ظˆط¯ط© ظˆظ„ظƒظ† طھظ… ظ†ظ‚ظ„ظ‡ط§)
-- ============================================================
local DROP_TYPES = {
    JUMP = "jump",
}
...
-- FIX: ط¥ظ†ط´ط§ط، presetListFrame ط¨ط´ظƒظ„ ط¢ظ…ظ† ظ‚ط¨ظ„ ط§ظ„ط§ط³طھط®ط¯ط§ظ…
...
presetListFrame.Parent = CoreGui  -- ط§ط³طھط®ط¯ظ…ظ†ط§ CoreGui ط¨ط¯ظ„ط§ظ‹ ظ…ظ† game:GetService("CoreGui") ظ…ط¨ط§ط´ط±ط©
